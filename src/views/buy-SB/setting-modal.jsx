...
export function SettingModal() {
  return (
    <div className="z-50 modal opacity-3  pointer-events-none fixed   w-full h-full top-0 left-0 flex items-center justify-center">
      <div className="modal-overlay mx-0 my-auto absolute w-full h-full bg-gray-900 opacity-50"></div>

      <div className="modal-container bg-gray-200 w-4/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
